...
export class RacingScene {
 ...
 async load(onProgress){
  ...
  const [horse,rider,tree,grass,sky,font,crowd,leaf,ceremony]=await Promise.all([
   gltf.loadAsync('/assets/models/racehorse.glb'),gltf.loadAsync('/assets/models/jockey.glb'),gltf.loadAsync('/assets/models/pine-web.glb'),textureLoader.loadAsync('/assets/textures/turf.png'),new RGBELoader(manager).loadAsync('/assets/textures/sky.hdr'),new FontLoader(manager).loadAsync('/assets/fonts/helvetiker_regular.typeface.json'),gltf.loadAsync('/assets/models/spectator.glb'),textureLoader.loadAsync('/assets/textures/zelkova.png'),gltf.loadAsync('/assets/models/ceremony.glb')
  ]);
